...
const CreateQuizScreen = ({ navigation }) => {
  ...
  const handleCreateGroup = () => {
    axios
      .post(`http://192.168.0.192:8080/api/group/addNewGroup/${data.groupName}/suryanshsharma1942@gmail.com`)
      .then((response) => {
  ...
  useEffect(() => {
    isLoading(true);
    axios.get(`http://192.168.0.192:8080/api/user/groups/suryanshsharma1942@gmail.com`)
    .then(response=>{
